    ...
    def test_file_EngineSpeed(self):
        ...
        try:
            ...
            self.assertSequenceEqual(
                values.channels[0].values.double_array.values, [0.0, 0.1, 0.2, 0.3])
            self.assertEqual(
                values.channels[1].values.data_type, ods.DataTypeEnum.DT_DOUBLE)
            self.assertSequenceEqual(
                values.channels[1].values.double_array.values, [0.0, 0.0, 0.0, 0.0])
        finally:
    ...
    def test_file_Latitude(self):
        ...
        try:
            ...
            self.assertEqual(
                values.channels[0].values.data_type, ods.DataTypeEnum.DT_DOUBLE)
            self.assertSequenceEqual(
                values.channels[0].values.double_array.values, [0.0, 1.0, 2.0, 3.0])
            self.assertEqual(
                values.channels[1].values.data_type, ods.DataTypeEnum.DT_DOUBLE)
            self.assertSequenceEqual(values.channels[1].values.double_array.values, [
                                     556089856.0, 556089856.0, 556089856.0, 556089856.0])
        finally:
            service.Close(handle, None)
    ...
    def test_file_Longitude(self):
        ...
        try:
            ...
            self.assertEqual(
                values.channels[1].values.data_type, ods.DataTypeEnum.DT_DOUBLE)
            self.assertSequenceEqual(values.channels[1].values.double_array.values, [
                                     129992016.0, 129992016.0, 129992024.0, 129992024.0])
        finally:
            service.Close(handle, None)
    ...
    def test_file_T_Engine_TC(self):
        ...
        try:
            ...
            self.assertEqual(
                values.channels[1].values.data_type, ods.DataTypeEnum.DT_DOUBLE)
            self.assertSequenceEqual(values.channels[1].values.double_array.values, [
                                     73.6875, 73.6875, 73.6875, 73.6875])
        finally:
            service.Close(handle, None)
